...
//Initialize the instance variables
    ...
    public ComplexNumber negate() {
        double nR = real * -1; //A stub: to be fixed
        double nI= imaginary * -1;
    ...
    public ComplexNumber add(ComplexNumber z) {
        ComplexNumber a = this;	//A stub: to be fixed
        double r = a.real + z.real;
        double i = a.imaginary + z.imaginary;
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        ComplexNumber a = this;	//A stub: to be fixed
        double r = a.real * z.real - a.imaginary * z.imaginary;
        double i = a.real * z.imaginary + a.imaginary * z.real;
        return new ComplexNumber(r, i);	//A stub: to be fixed
    }
    ...
    public ComplexNumber reciprocal() {
        ...
        return new ComplexNumber(real / sum, -imaginary / sum); //conjugate of complex number real - imaginary
    }
